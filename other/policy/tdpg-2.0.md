...
หน่วยงานของคุณมีการกำหนดนโยบายอย่างไร เก็บข้อมูลอะไรบ้าง สามารถกำหนดนโยบายตาม TDPG 2.0 ก็ได้
...
กำหนดขั้นตอนการตรวจสอบข้อมูลอย่างไร ระบบตรวจสอบก่อนจัดเก็บหรือไม่ หรือใช้คนในการตรวจสอบ

</details>

<details>

<summary>Data Proliferation</summary>

ระบุแหล่งที่มาของข้อมูล และเส้นทางการไหลขอลข้อมูล รวมถึงการกำหนดบุคคลที่เกี่ยวข้อง ทั้ง 4 ประเภท
...
กำหนดระดับความเสี่ยง โอกาสเกิดและระดับความรุนแรงของผลกระทบ โดยยึดหลักของ Confidentiality, Integrity, Availability ( CIA ) โดยทั่วไปจะแบ่งเป็น 3 ระดับ
...
<summary>ฐานเอกสารประวัติศาสตร์ จดหมายเหตุ งานวิจัย ( Research )</summary>
...
<summary>ฐานประโยชน์สำคัญต่อชีวิต ( Vital Interest )</summary>
...
<summary>ฐานสัญญา ( Contract ) ใช้ได้กับข้อมูลส่วนบุคคทั่วไป ข้อมูลอ่อนไหวใช้ไม่ได้</summary>
...
<summary>ภารกิจของรัฐ ( Public Task )</summary>
...
<summary>ฐานประโยชน์อันชอบธรรม ( Legitimate Interest )</summary>
...
<summary>ฐานการปฏิบัติตามกฎหมาย ( Legal Obligation )</summary>
...
<summary>การประมวลผลข้อมูลส่วนบุคคลจำนวนมากด้วยระบบอัตโนมัติ</summary>
...
<summary>การประมวลผลข้อมูลอ่อนไหวจำนวนมาก</summary>
...
<summary>การเฝ้าระวังในที่สาธารณะ</summary>
...
<summary>การส่งหรือโอน ( Transfer )</summary>

ผู้รับข้อมูล หรือ ประเทศปลายทางต้องอยู่ต่างประเทศ ยกเว้น ผู้รับข้อมูลเป็นนิติบุคคลเดียวกันกับผู้ควบคุมข้อมูลแล้วเดินทางไปต่างประเทศ จะถือเป็นการส่งผ่าน

</details>

<details>

<summary>การส่งผ่าน ( Transit )</summary>

ผู้รับข้อมูล หรือ ประเทศปลายทางอยู่ภายในประเทศ ถึงแม้ข้อมูลจะวิ่งผ่านเครื่อง Server ที่อยู่ต่างประเทศก็ตาม
...
<summary>Formal Anonymisation</summary>
...
<summary>Guaranteed Anonymisation</summary>
...
<summary>Statistical Anonymisation</summary>
...
<summary>Functional Anonymization</summary>
